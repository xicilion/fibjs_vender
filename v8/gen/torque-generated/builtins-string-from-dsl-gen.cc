...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp60);
    tmp60 = ca_.UncheckedCast<Number>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr22UT12ATHeapNumber5ATSmi17ATconstexpr_int31(0));
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp24);
    tmp24 = ca_.UncheckedCast<Number>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr22UT12ATHeapNumber5ATSmi17ATconstexpr_int31(0));
    compiler::TNode<Number> tmp25;
    USE(tmp25);
