...
class ArrayBuiltinsFromDSLAssembler {
 public:
  ...
  void CannotUseSameArrayAccessor14ATJSTypedArray(compiler::TNode<Context> p_context, compiler::TNode<BuiltinPtr> p_loadFn, compiler::TNode<JSReceiver> p_receiver, compiler::TNode<Map> p_initialMap, compiler::TNode<Number> p_initialLen, compiler::CodeAssemblerLabel* label_Cannot, compiler::CodeAssemblerLabel* label_Can);
  ...
  compiler::TNode<BuiltinPtr> UnsafeCast102FT9ATContext20UT5ATSmi10HeapObject20UT5ATSmi10HeapObject20UT5ATSmi10HeapObject22UT12ATHeapNumber5ATSmi(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  compiler::TNode<BuiltinPtr> UnsafeCast66FT9ATContext12ATFixedArray10HeapObject5ATSmi20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  compiler::TNode<BuiltinPtr> UnsafeCast72FT9ATContext12ATFixedArray10HeapObject5ATSmi20UT5ATSmi10HeapObject5ATSmi(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  compiler::TNode<BuiltinPtr> UnsafeCast89FT9ATContext10JSReceiver20UT5ATSmi10HeapObject22UT12ATHeapNumber5ATSmi17UT7ATFalse6ATTrue(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  ...
  compiler::TNode<BuiltinPtr> GetLoadFn(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState);
  compiler::TNode<BuiltinPtr> GetStoreFn(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState);
  compiler::TNode<BuiltinPtr> GetCanUseSameAccessorFn(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState);
  ...
  compiler::TNode<Object> CallLoad(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<HeapObject> p_elements, compiler::TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_Bailout);
  void CallStore(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_store, compiler::TNode<HeapObject> p_elements, compiler::TNode<Smi> p_index, compiler::TNode<Object> p_value, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  compiler::TNode<Smi> CallGallopLeft(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<Object> p_key, compiler::TNode<Smi> p_base, compiler::TNode<Smi> p_length, compiler::TNode<Smi> p_hint, compiler::TNode<Oddball> p_useTempArray, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  void CopyToTempArray(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<HeapObject> p_srcElements, compiler::TNode<Smi> p_srcPos, compiler::TNode<FixedArray> p_tempArray, compiler::TNode<Smi> p_dstPos, compiler::TNode<Smi> p_length, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  void ReverseRange(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<BuiltinPtr> p_store, compiler::TNode<HeapObject> p_elements, compiler::TNode<Smi> p_from, compiler::TNode<Smi> p_to, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  void CopyElement(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<BuiltinPtr> p_store, compiler::TNode<HeapObject> p_elements, compiler::TNode<Smi> p_from, compiler::TNode<Smi> p_to, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  void FilterVisitAllElements12ATFixedArray(compiler::TNode<Context> p_context, ElementsKind p_kind, compiler::TNode<JSArray> p_o, compiler::TNode<Smi> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::TNode<JSArray> p_a, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1);
  void FilterVisitAllElements18ATFixedDoubleArray(compiler::TNode<Context> p_context, ElementsKind p_kind, compiler::TNode<JSArray> p_o, compiler::TNode<Smi> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::TNode<JSArray> p_a, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1);
  void VisitAllElements18ATFixedDoubleArray(compiler::TNode<Context> p_context, compiler::TNode<JSArray> p_o, compiler::TNode<Smi> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0);
  void VisitAllElements12ATFixedArray(compiler::TNode<Context> p_context, compiler::TNode<JSArray> p_o, compiler::TNode<Smi> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0);
