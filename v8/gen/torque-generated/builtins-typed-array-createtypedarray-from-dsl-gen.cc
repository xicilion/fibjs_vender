...
void TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler::ConstructByArrayLike(compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_typedArray, compiler::TNode<HeapObject> p_arrayLike, compiler::TNode<Object> p_initialLength, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo p_elementsInfo, compiler::TNode<JSReceiver> p_bufferConstructor) {
  ...
  if (block16.is_used()) {
    ...
    USE(tmp131);
    tmp131 = ca_.UncheckedCast<RawPtrT>(TypedArrayBuiltinsAssembler(state_).LoadDataPtr(compiler::TNode<JSTypedArray>{tmp121}));
    compiler::TNode<RawPtrT> tmp132;
    USE(tmp132);
    tmp132 = ca_.UncheckedCast<RawPtrT>(TypedArrayBuiltinsAssembler(state_).LoadDataPtr(compiler::TNode<JSTypedArray>{tmp130}));
    TypedArrayBuiltinsAssembler(state_).CallCMemcpy(compiler::TNode<RawPtrT>{tmp131}, compiler::TNode<RawPtrT>{tmp132}, compiler::TNode<UintPtrT>{tmp129});
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 128);
    ca_.Goto(&block17, tmp120, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128, tmp129, tmp130);
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Bind(&block17, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139, &tmp140, &tmp141, &tmp142, &tmp143);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 125);
    ca_.Goto(&block15, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139, tmp140, tmp141, tmp142, tmp143);
  }
  ...
  if (block15.is_used()) {
    ...
    ca_.Bind(&block15, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 122);
    ca_.Goto(&block12, tmp144, tmp145, tmp146, tmp147, tmp148, tmp149, tmp150, tmp151, tmp152, tmp153, tmp154);
  }
  ...
  if (block12.is_used()) {
    ...
    ca_.Bind(&block12, &tmp155, &tmp156, &tmp157, &tmp158, &tmp159, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164, &tmp165);
    ...
    ca_.Goto(&block6, tmp155, tmp156, tmp157, tmp158, tmp159, tmp160, tmp161, tmp162, tmp163, tmp164);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block7, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174, &tmp175);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 134);
    compiler::TNode<Smi> tmp176;
    USE(tmp176);
    tmp176 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi17ATconstexpr_int31(0));
    compiler::TNode<BoolT> tmp177;
    USE(tmp177);
    tmp177 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiGreaterThan(compiler::TNode<Smi>{tmp174}, compiler::TNode<Smi>{tmp176}));
    ca_.Branch(tmp177, &block18, &block19, tmp166, tmp167, tmp168, tmp169, tmp170, tmp171, tmp172, tmp173, tmp174, tmp175);
  }
  ...
  if (block18.is_used()) {
    ...
    ca_.Bind(&block18, &tmp178, &tmp179, &tmp180, &tmp181, &tmp182, &tmp183, &tmp184, &tmp185, &tmp186, &tmp187);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 135);
    CodeStubAssembler(state_).CallRuntime(Runtime::kTypedArrayCopyElements, tmp178, tmp179, tmp180, tmp186);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 134);
    ca_.Goto(&block19, tmp178, tmp179, tmp180, tmp181, tmp182, tmp183, tmp184, tmp185, tmp186, tmp187);
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Bind(&block19, &tmp189, &tmp190, &tmp191, &tmp192, &tmp193, &tmp194, &tmp195, &tmp196, &tmp197, &tmp198);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 119);
    ca_.Goto(&block6, tmp189, tmp190, tmp191, tmp192, tmp193, tmp194, tmp195, tmp196, tmp197, tmp198);
  }
  ...
  if (block6.is_used()) {
    ...
    ca_.Bind(&block6, &tmp199, &tmp200, &tmp201, &tmp202, &tmp203, &tmp204, &tmp205, &tmp206, &tmp207, &tmp208);
    ...
    ca_.Goto(&block1, tmp199, tmp200, tmp201, tmp202, tmp203, tmp204, tmp205, tmp206);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp209, &tmp210, &tmp211, &tmp212, &tmp213, &tmp214, &tmp215, &tmp216);
    ca_.Goto(&block20, tmp209, tmp210, tmp211, tmp212, tmp213, tmp214, tmp215, tmp216);
  }
    ...
    ca_.Bind(&block20, &tmp217, &tmp218, &tmp219, &tmp220, &tmp221, &tmp222, &tmp223, &tmp224);
}
...
TF_BUILTIN(CreateTypedArray, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<UintPtrT> tmp7;
    USE(tmp7);
    tmp7 = ca_.UncheckedCast<UintPtrT>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr9ATuintptr17ATconstexpr_int31(0));
    BaseBuiltinsFromDSLAssembler(state_).StoreJSArrayBufferViewByteOffset(compiler::TNode<JSArrayBufferView>{tmp6}, compiler::TNode<UintPtrT>{tmp7});
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 295);
    compiler::TNode<UintPtrT> tmp8;
    USE(tmp8);
    tmp8 = ca_.UncheckedCast<UintPtrT>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr9ATuintptr17ATconstexpr_int31(0));
    BaseBuiltinsFromDSLAssembler(state_).StoreJSArrayBufferViewByteLength(compiler::TNode<JSArrayBufferView>{tmp6}, compiler::TNode<UintPtrT>{tmp8});
    ...
    USE(tmp11);
    std::tie(tmp9, tmp10, tmp11) = TypedArrayBuiltinsAssembler(state_).GetTypedArrayElementsInfo(compiler::TNode<JSTypedArray>{tmp6}).Flatten();
    ...
    USE(tmp12);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp12 = BaseBuiltinsFromDSLAssembler(state_).Cast5ATSmi(compiler::TNode<Object>{tmp3}, &label0);
    ca_.Goto(&block7, tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp9, tmp10, tmp11, tmp3, tmp3, tmp12);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block8, tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp9, tmp10, tmp11, tmp3, tmp3);
    }
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.Bind(&block8, &tmp13, &tmp14, &tmp15, &tmp16, &tmp17, &tmp18, &tmp19, &tmp20, &tmp21, &tmp22, &tmp23, &tmp24);
    ca_.Goto(&block6, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block7, &tmp25, &tmp26, &tmp27, &tmp28, &tmp29, &tmp30, &tmp31, &tmp32, &tmp33, &tmp34, &tmp35, &tmp36, &tmp37);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 305);
    ca_.Goto(&block4, tmp25, tmp26, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp37);
  }
  ...
  if (block6.is_used()) {
    ...
    USE(tmp49);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp49 = BaseBuiltinsFromDSLAssembler(state_).Cast13JSArrayBuffer(compiler::TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(tmp48)}, &label0);
    ca_.Goto(&block11, tmp38, tmp39, tmp40, tmp41, tmp42, tmp43, tmp44, tmp45, tmp46, tmp47, tmp48, ca_.UncheckedCast<HeapObject>(tmp48), tmp49);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block12, tmp38, tmp39, tmp40, tmp41, tmp42, tmp43, tmp44, tmp45, tmp46, tmp47, tmp48, ca_.UncheckedCast<HeapObject>(tmp48));
    }
  }

  if (block12.is_used()) {
    compiler::TNode<Context> tmp50;
    compiler::TNode<JSFunction> tmp51;
    compiler::TNode<JSReceiver> tmp52;
    compiler::TNode<Object> tmp53;
    ...
    ca_.Bind(&block12, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57, &tmp58, &tmp59, &tmp60, &tmp61);
    ca_.Goto(&block10, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp56, tmp57, tmp58, tmp59, tmp60);
  }

  if (block11.is_used()) {
    compiler::TNode<Context> tmp62;
    compiler::TNode<JSFunction> tmp63;
    compiler::TNode<JSReceiver> tmp64;
    ...
    compiler::TNode<JSArrayBuffer> tmp74;
    ca_.Bind(&block11, &tmp62, &tmp63, &tmp64, &tmp65, &tmp66, &tmp67, &tmp68, &tmp69, &tmp70, &tmp71, &tmp72, &tmp73, &tmp74);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 308);
    TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler(state_).ConstructByArrayBuffer(compiler::TNode<Context>{tmp62}, compiler::TNode<JSTypedArray>{tmp68}, compiler::TNode<JSArrayBuffer>{tmp74}, compiler::TNode<Object>{tmp66}, compiler::TNode<Object>{tmp67}, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo{compiler::TNode<UintPtrT>{tmp69}, compiler::TNode<Map>{tmp70}, compiler::TNode<Int32T>{tmp71}});
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 307);
    ca_.Goto(&block9, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp71, tmp72);
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Bind(&block10, &tmp75, &tmp76, &tmp77, &tmp78, &tmp79, &tmp80, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 310);
    compiler::TNode<JSTypedArray> tmp86;
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = BaseBuiltinsFromDSLAssembler(state_).Cast12JSTypedArray(compiler::TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(tmp85)}, &label0);
    ca_.Goto(&block15, tmp75, tmp76, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84, tmp85, ca_.UncheckedCast<HeapObject>(tmp85), tmp86);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block16, tmp75, tmp76, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84, tmp85, ca_.UncheckedCast<HeapObject>(tmp85));
    }
  }
  ...
  if (block16.is_used()) {
    ...
    compiler::TNode<Object> tmp97;
    compiler::TNode<HeapObject> tmp98;
    ca_.Bind(&block16, &tmp87, &tmp88, &tmp89, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97, &tmp98);
    ca_.Goto(&block14, tmp87, tmp88, tmp89, tmp90, tmp91, tmp92, tmp93, tmp94, tmp95, tmp96, tmp97);
  }

  if (block15.is_used()) {
    compiler::TNode<Context> tmp99;
    compiler::TNode<JSFunction> tmp100;
    ...
    compiler::TypedCodeAssemblerVariable<JSReceiver> result_0_2(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler(state_).ConstructByTypedArray(compiler::TNode<Context>{tmp99}, compiler::TNode<JSTypedArray>{tmp105}, compiler::TNode<JSTypedArray>{tmp111}, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo{compiler::TNode<UintPtrT>{tmp106}, compiler::TNode<Map>{tmp107}, compiler::TNode<Int32T>{tmp108}}, &label0, &result_0_0, &result_0_1, &result_0_2);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block17, tmp99, tmp100, tmp101, tmp102, tmp103, tmp104, tmp105, tmp106, tmp107, tmp108, tmp109, tmp111, tmp105, tmp111, tmp106, tmp107, tmp108, result_0_0.value(), result_0_1.value(), result_0_2.value());
    }
  }
  ...
  if (block17.is_used()) {
    ...
    ca_.Bind(&block17, &tmp112, &tmp113, &tmp114, &tmp115, &tmp116, &tmp117, &tmp118, &tmp119, &tmp120, &tmp121, &tmp122, &tmp123, &tmp124, &tmp125, &tmp126, &tmp127, &tmp128, &tmp129, &tmp130, &tmp131);
    ca_.Goto(&block2, tmp112, tmp113, tmp114, tmp115, tmp116, tmp117, tmp118, tmp119, tmp120, tmp121, tmp129, tmp130, tmp131);
  }

  if (block14.is_used()) {
    compiler::TNode<Context> tmp132;
    compiler::TNode<JSFunction> tmp133;
    ...
    compiler::TNode<Object> tmp142;
    ca_.Bind(&block14, &tmp132, &tmp133, &tmp134, &tmp135, &tmp136, &tmp137, &tmp138, &tmp139, &tmp140, &tmp141, &tmp142);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 314);
    compiler::TNode<JSReceiver> tmp143;
    USE(tmp143);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp143 = BaseBuiltinsFromDSLAssembler(state_).Cast10JSReceiver(compiler::TNode<Context>{tmp132}, compiler::TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(tmp142)}, &label0);
    ca_.Goto(&block20, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139, tmp140, tmp141, tmp142, ca_.UncheckedCast<HeapObject>(tmp142), tmp143);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block21, tmp132, tmp133, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139, tmp140, tmp141, tmp142, ca_.UncheckedCast<HeapObject>(tmp142));
    }
  }

  if (block21.is_used()) {
    compiler::TNode<Context> tmp144;
    compiler::TNode<JSFunction> tmp145;
    ...
    ca_.Bind(&block21, &tmp144, &tmp145, &tmp146, &tmp147, &tmp148, &tmp149, &tmp150, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155);
    ca_.Goto(&block19, tmp144, tmp145, tmp146, tmp147, tmp148, tmp149, tmp150, tmp151, tmp152, tmp153, tmp154);
  }

  if (block20.is_used()) {
    compiler::TNode<Context> tmp156;
    compiler::TNode<JSFunction> tmp157;
    ...
    ca_.Bind(&block20, &tmp156, &tmp157, &tmp158, &tmp159, &tmp160, &tmp161, &tmp162, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167, &tmp168);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 315);
    compiler::TypedCodeAssemblerVariable<HeapObject> result_0_0(&ca_);
    compiler::TypedCodeAssemblerVariable<Object> result_0_1(&ca_);
    compiler::TypedCodeAssemblerVariable<JSReceiver> result_0_2(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler(state_).ConstructByJSReceiver(compiler::TNode<Context>{tmp156}, compiler::TNode<JSTypedArray>{tmp162}, compiler::TNode<JSReceiver>{tmp168}, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo{compiler::TNode<UintPtrT>{tmp163}, compiler::TNode<Map>{tmp164}, compiler::TNode<Int32T>{tmp165}}, &label0, &result_0_0, &result_0_1, &result_0_2);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block22, tmp156, tmp157, tmp158, tmp159, tmp160, tmp161, tmp162, tmp163, tmp164, tmp165, tmp166, tmp168, tmp162, tmp168, tmp163, tmp164, tmp165, result_0_0.value(), result_0_1.value(), result_0_2.value());
    }
  }
  ...
  if (block22.is_used()) {
    ...
    ca_.Bind(&block22, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174, &tmp175, &tmp176, &tmp177, &tmp178, &tmp179, &tmp180, &tmp181, &tmp182, &tmp183, &tmp184, &tmp185, &tmp186, &tmp187, &tmp188);
    ca_.Goto(&block2, tmp169, tmp170, tmp171, tmp172, tmp173, tmp174, tmp175, tmp176, tmp177, tmp178, tmp186, tmp187, tmp188);
  }
  ...
  if (block19.is_used()) {
    ...
    ca_.Bind(&block19, &tmp189, &tmp190, &tmp191, &tmp192, &tmp193, &tmp194, &tmp195, &tmp196, &tmp197, &tmp198, &tmp199);
    ...
    ca_.Goto(&block4, tmp189, tmp190, tmp191, tmp192, tmp193, tmp194, tmp195, tmp196, tmp197, tmp198, ca_.UncheckedCast<HeapObject>(tmp199));
  }

  if (block9.is_used()) {
    compiler::TNode<Context> tmp200;
    compiler::TNode<JSFunction> tmp201;
    ...
    ca_.Bind(&block9, &tmp200, &tmp201, &tmp202, &tmp203, &tmp204, &tmp205, &tmp206, &tmp207, &tmp208, &tmp209, &tmp210);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 304);
    ca_.Goto(&block5, tmp200, tmp201, tmp202, tmp203, tmp204, tmp205, tmp206, tmp207, tmp208, tmp209, tmp210);
  }

  if (block5.is_used()) {
    compiler::TNode<Context> tmp211;
    compiler::TNode<JSFunction> tmp212;
    ...
    compiler::TNode<Object> tmp221;
    ca_.Bind(&block5, &tmp211, &tmp212, &tmp213, &tmp214, &tmp215, &tmp216, &tmp217, &tmp218, &tmp219, &tmp220, &tmp221);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 303);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 325);
    ca_.Goto(&block3, tmp211, tmp212, tmp213, tmp214, tmp215, tmp216, tmp217, tmp218, tmp219, tmp220);
  }

  if (block4.is_used()) {
    compiler::TNode<Context> tmp222;
    compiler::TNode<JSFunction> tmp223;
    compiler::TNode<JSReceiver> tmp224;
    ...
    ca_.Bind(&block4, &tmp222, &tmp223, &tmp224, &tmp225, &tmp226, &tmp227, &tmp228, &tmp229, &tmp230, &tmp231, &tmp232);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 326);
    TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler(state_).ConstructByLength(compiler::TNode<Context>{tmp222}, compiler::TNode<JSTypedArray>{tmp228}, compiler::TNode<Object>{tmp232}, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo{compiler::TNode<UintPtrT>{tmp229}, compiler::TNode<Map>{tmp230}, compiler::TNode<Int32T>{tmp231}});
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 302);
    ca_.Goto(&block3, tmp222, tmp223, tmp224, tmp225, tmp226, tmp227, tmp228, tmp229, tmp230, tmp231);
  }

  if (block3.is_used()) {
    compiler::TNode<Context> tmp233;
    compiler::TNode<JSFunction> tmp234;
    ...
    ca_.Bind(&block3, &tmp233, &tmp234, &tmp235, &tmp236, &tmp237, &tmp238, &tmp239, &tmp240, &tmp241, &tmp242);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 328);
    ca_.Goto(&block1, tmp233, tmp234, tmp235, tmp236, tmp237, tmp238, tmp239, tmp240, tmp241, tmp242);
  }

  if (block2.is_used()) {
    compiler::TNode<Context> tmp243;
    compiler::TNode<JSFunction> tmp244;
    compiler::TNode<JSReceiver> tmp245;
    compiler::TNode<Object> tmp246;
    ...
    ca_.Bind(&block2, &tmp243, &tmp244, &tmp245, &tmp246, &tmp247, &tmp248, &tmp249, &tmp250, &tmp251, &tmp252, &tmp253, &tmp254, &tmp255);
    ...
    TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler(state_).ConstructByArrayLike(compiler::TNode<Context>{tmp243}, compiler::TNode<JSTypedArray>{tmp249}, compiler::TNode<HeapObject>{tmp253}, compiler::TNode<Object>{tmp254}, TypedArrayBuiltinsFromDSLAssembler::TypedArrayElementsInfo{compiler::TNode<UintPtrT>{tmp250}, compiler::TNode<Map>{tmp251}, compiler::TNode<Int32T>{tmp252}}, compiler::TNode<JSReceiver>{tmp255});
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 302);
    ca_.Goto(&block1, tmp243, tmp244, tmp245, tmp246, tmp247, tmp248, tmp249, tmp250, tmp251, tmp252);
  }
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Map> tmp264;
    compiler::TNode<Int32T> tmp265;
    ca_.Bind(&block1, &tmp256, &tmp257, &tmp258, &tmp259, &tmp260, &tmp261, &tmp262, &tmp263, &tmp264, &tmp265);
...
compiler::TNode<JSTypedArray> TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler::TypedArraySpeciesCreate(compiler::TNode<Context> p_context, const char* p_methodName, int31_t p_numArgs, compiler::TNode<JSTypedArray> p_exemplar, compiler::TNode<Object> p_arg0, compiler::TNode<Object> p_arg1, compiler::TNode<Object> p_arg2) {
  ...
  if (block7.is_used()) {
    ...
    ca_.Goto(&block1, tmp28, tmp29, tmp30, tmp31, tmp32, tmp34);
  }
  ...
  if (block3.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp41;
    USE(tmp41);
    tmp41 = ca_.UncheckedCast<JSReceiver>(CodeStubAssembler(state_).SpeciesConstructor(compiler::TNode<Context>{tmp35}, compiler::TNode<Object>{tmp36}, compiler::TNode<JSReceiver>{tmp40}));
    compiler::TNode<JSReceiver> tmp42;
    USE(tmp42);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp42 = BaseBuiltinsFromDSLAssembler(state_).Cast13ATConstructor(compiler::TNode<HeapObject>{tmp41}, &label0);
    ca_.Goto(&block10, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41, tmp42);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block11, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41);
    }
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Goto(&block9, tmp43, tmp44, tmp45, tmp46, tmp47, tmp48);
  }
  ...
  if (block10.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp57;
    ca_.Bind(&block10, &tmp50, &tmp51, &tmp52, &tmp53, &tmp54, &tmp55, &tmp56, &tmp57);
    ca_.Goto(&block8, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp57);
  }
  ...
  if (block8.is_used()) {
    ...
    USE(tmp71);
    tmp71 = BaseBuiltinsFromDSLAssembler(state_).Undefined();
    ...
    if (((CodeStubAssembler(state_).ConstexprInt31Equal(p_numArgs, 1)))) {
      ca_.Goto(&block12, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp71);
    } else {
      ca_.Goto(&block13, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp71);
    }
  }
  ...
  if (block12.is_used()) {
    ...
    compiler::TNode<JSFunction> tmp77;
    ...
    compiler::TNode<JSReceiver> tmp80;
    USE(tmp80);
    tmp80 = ca_.UncheckedCast<JSReceiver>(CodeStubAssembler(state_).Construct(compiler::TNode<Context>{tmp72}, compiler::TNode<JSReceiver>{tmp78}, compiler::TNode<Object>{tmp74}));
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 363);
    ca_.Goto(&block14, tmp72, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp80);
  }
  ...
  if (block13.is_used()) {
    ...
    compiler::TNode<JSReceiver> tmp87;
    compiler::TNode<Object> tmp88;
    ca_.Bind(&block13, &tmp81, &tmp82, &tmp83, &tmp84, &tmp85, &tmp86, &tmp87, &tmp88);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 367);
    compiler::TNode<JSReceiver> tmp89;
    USE(tmp89);
    tmp89 = ca_.UncheckedCast<JSReceiver>(CodeStubAssembler(state_).Construct(compiler::TNode<Context>{tmp81}, compiler::TNode<JSReceiver>{tmp87}, compiler::TNode<Object>{tmp83}, compiler::TNode<Object>{tmp84}, compiler::TNode<Object>{tmp85}));
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 363);
    ca_.Goto(&block14, tmp81, tmp82, tmp83, tmp84, tmp85, tmp86, tmp87, tmp89);
  }
  ...
  if (block14.is_used()) {
    ...
    compiler::TNode<JSFunction> tmp95;
    compiler::TNode<JSReceiver> tmp96;
    compiler::TNode<Object> tmp97;
    ca_.Bind(&block14, &tmp90, &tmp91, &tmp92, &tmp93, &tmp94, &tmp95, &tmp96, &tmp97);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 370);
    compiler::TNode<JSTypedArray> tmp98;
    USE(tmp98);
    tmp98 = ca_.UncheckedCast<JSTypedArray>(TypedArrayBuiltinsAssembler(state_).ValidateTypedArray(compiler::TNode<Context>{tmp90}, compiler::TNode<Object>{tmp97}, p_methodName));
    ca_.Goto(&block1, tmp90, tmp91, tmp92, tmp93, tmp94, tmp98);
  }
  ...
  if (block1.is_used()) {
    ...
    compiler::TNode<Object> tmp103;
    compiler::TNode<JSTypedArray> tmp104;
    ca_.Bind(&block1, &tmp99, &tmp100, &tmp101, &tmp102, &tmp103, &tmp104);
    ca_.SetSourcePosition("../../src/builtins/typed-array-createtypedarray.tq", 336);
    ca_.Goto(&block15, tmp99, tmp100, tmp101, tmp102, tmp103, tmp104);
  }
    ...
    ca_.Bind(&block15, &tmp105, &tmp106, &tmp107, &tmp108, &tmp109, &tmp110);
  return compiler::TNode<JSTypedArray>{tmp110};
}
...
compiler::TNode<JSTypedArray> TypedArrayCreatetypedarrayBuiltinsFromDSLAssembler::TypedArraySpeciesCreateByLength(compiler::TNode<Context> p_context, const char* p_methodName, compiler::TNode<JSTypedArray> p_exemplar, compiler::TNode<Smi> p_length) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp6);
    tmp6 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).LoadJSTypedArrayLength(compiler::TNode<JSTypedArray>{tmp5}));
    compiler::TNode<BoolT> tmp7;
    USE(tmp7);
    tmp7 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiLessThan(compiler::TNode<Smi>{tmp6}, compiler::TNode<Smi>{tmp2}));
    ca_.Branch(tmp7, &block2, &block3, tmp0, tmp1, tmp2, tmp5);
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp8}, MessageTemplate::kTypedArrayTooShort);
  }
  ...
  if (block3.is_used()) {
    ...
    compiler::TNode<JSTypedArray> tmp15;
    ca_.Bind(&block3, &tmp12, &tmp13, &tmp14, &tmp15);
  ...
  if (block1.is_used()) {
    ...
    ca_.Goto(&block4, tmp16, tmp17, tmp18, tmp19);
  }
