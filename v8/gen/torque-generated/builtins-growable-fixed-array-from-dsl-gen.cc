...
GrowableFixedArrayBuiltinsFromDSLAssembler::GrowableFixedArray GrowableFixedArrayBuiltinsFromDSLAssembler::NewGrowableFixedArray() {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp1);
    tmp1 = ca_.UncheckedCast<IntPtrT>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr8ATintptr17ATconstexpr_int31(0));
  ...
  return GrowableFixedArrayBuiltinsFromDSLAssembler::GrowableFixedArray{compiler::TNode<FixedArray>{tmp6}, compiler::TNode<IntPtrT>{tmp7}, compiler::TNode<IntPtrT>{tmp8}};
}
